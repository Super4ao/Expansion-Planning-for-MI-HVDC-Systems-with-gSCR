...
def CalBr(Bus_B_MX, HVDC_Bus, Load_Bus):
...
def prepare_data(Case, T, MaxGenNum, r, n, D, SCR0, DailyLoadRate, Exit_Brh, Exit_Gen):
    crf = (r * (1 + r) ** n) / ((1 + r) ** n - 1)
    ...
    return {
        ...
        'BusAdj_complement_pairs': BusAdj_complement_pairs, 'Exit_Brh': Exit_Brh, 'Exit_Gen': Exit_Gen, 'D': D, 'SCR0': SCR0, 'T': T
    }
